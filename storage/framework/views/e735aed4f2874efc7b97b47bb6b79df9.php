...
<div class="container mx-auto p-6">
    ...
    <div class="relative border overflow-x-auto shadow-md sm:rounded-lg pt-3">
        ...
        <div class="content-item bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <!-- Delete Button -->
            <form action="<?php echo e(route('director.delete-plan', $plan->id)); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.director.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/director/my-plans.blade.php ENDPATH**/ ?>