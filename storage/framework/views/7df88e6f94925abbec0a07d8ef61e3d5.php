...
<div class="container mx-auto p-6">
    ...
    <div class="relative border overflow-x-auto shadow-md sm:rounded-lg pt-3">
        ...
        <div class="content-item bg-white shadow-md rounded-lg p-6 mb-6">
            <h3 class="text-xl font-semibold mb-2">Report Topic: <?php echo e($report->topic); ?></h3>
            ...
            <div class="mb-4">
                <video class="w-full max-w-md" controls>
                    <source src="<?php echo e(asset('storage/' . $report->video)); ?>" type="video/mp4">
            ...
            <!-- Comments Section -->
            <hr class="my-4">
            <h4 class="text-lg font-medium mb-2">Comments from Vice President</h4>
            ...
            <!-- Delete Button -->
            <form action="<?php echo e(route('director.delete-report', $report->id)); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.director.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/director/my-reports.blade.php ENDPATH**/ ?>