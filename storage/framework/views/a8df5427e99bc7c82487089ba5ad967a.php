...
<div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form action="<?php echo e(route('admin.user-update', $user)); ?>" method="POST" class="max-w-sm mx-auto mb-8">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>