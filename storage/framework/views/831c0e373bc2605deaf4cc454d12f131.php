                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="<?php echo e(route('dept.users')); ?>"
                                ...
                                <span class="ml-3">Manage Workflow</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('division.index')); ?>"
                                ...
                                <span class="ml-3">Division Management</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('office.index')); ?>"
                                ...
                                <span class="ml-3">Office Management</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('campus.index')); ?>"
                                class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                <svg aria-hidden="true"
                                    class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                    fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="ml-3">Campus Management</span>
                            </a>
                        </li>
...
</html><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/layouts/admin/dashboard.blade.php ENDPATH**/ ?>