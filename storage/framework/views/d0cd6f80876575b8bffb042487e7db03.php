...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-semibold mb-4">Vice President report</h2>
    ...
    <div class="bg-white shadow-md rounded-lg p-4 mb-6">
        <h3 class="text-xl font-bold mb-2">Title: <?php echo e($report->title); ?></h3>
        <p>Submitted by: <?php echo e($report->office->name); ?></p>
        <p class="text-gray-700 mb-4">Description: <?php echo e($report->description); ?></p>

        <?php if($report->document): ?>
        <a href="<?php echo e(asset('storage/' . $report->document)); ?>" class="text-blue-500 hover:underline mb-4 block" target="_blank">Download Document</a>
        <?php endif; ?>
        ...
        <div class="flex gap-4">
            <form action="<?php echo e(route('president.approve-content', $report->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" class="approve-button">Approve</button>
            </form>
            <form action="<?php echo e(route('president.disapprove-content', $report->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <!-- Add a comment -->
        <form action="<?php echo e(route('president.add-comment', $report->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<?php echo $__env->make('layouts.president.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/president/view-vice_president-reports.blade.php ENDPATH**/ ?>