...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-bold mb-6">Create Report for Office</h2>
    <form action="<?php echo e(route('director.store-report-for-office')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.director.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/director/create-report-for-office.blade.php ENDPATH**/ ?>