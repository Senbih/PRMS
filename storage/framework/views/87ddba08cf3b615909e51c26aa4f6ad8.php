...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-semibold mb-4">Vice President Plans</h2>
    ...
    <div class="bg-white shadow-md rounded-lg p-4 mb-6">
        ...
        <p>Submitted by: <?php echo e($content->office->name); ?></p>
        ...
        <div class="flex gap-4">
            <form action="<?php echo e(route('president.approve-content', $content->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" class="approve-button">Approve</button>
            </form>
            <form action="<?php echo e(route('president.disapprove-content', $content->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <!-- Add a comment -->
        <form action="<?php echo e(route('president.add-comment', $content->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<?php echo $__env->make('layouts.president.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/president/view-content.blade.php ENDPATH**/ ?>