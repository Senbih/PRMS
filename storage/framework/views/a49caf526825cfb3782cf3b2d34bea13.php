...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-bold mb-6">Create Plan</h2>
    <form action="<?php echo e(route('staff.store-content')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="mt-1 block w-full border-gray-300 rounded-md bg-gray-100 text-gray-700" value="<?php echo e($department->name); ?>" readonly>
...
<?php echo $__env->make('layouts.staff.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/staff/create-content.blade.php ENDPATH**/ ?>