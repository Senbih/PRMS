...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-semibold mb-4">Staff report</h2>
    ...
    <div class="bg-white shadow-md rounded-lg p-4 mb-6">
        ...
        <p>Submitted by: <?php echo e($report->staff->name); ?></p>
        ...
        <div class="flex gap-4">
            <form action="<?php echo e(route('teamleader.approve-content', $report->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button type="submit" class="approve-button">Approve</button>
            </form>
            <form action="<?php echo e(route('teamleader.disapprove-content', $report->id)); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <!-- Add a comment -->
        <form action="<?php echo e(route('teamleader.add-comment', $report->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
...
<?php echo $__env->make('layouts.teamleader.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\leti\Desktop\PRMS - Copy\resources\views/teamleader/view-staff-reports.blade.php ENDPATH**/ ?>